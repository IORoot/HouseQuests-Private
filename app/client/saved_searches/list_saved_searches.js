    ...
    if (savedSearches){
        ...
        for (const key in savedSearches) {
            ...
            savedItemsList += '<div class="flex flex-row gap-2 h-12">'
                ...
                savedItemsList += '<button data-saved-search-title="'+saveTitle+'" type="button" class="load-saved-search whitespace-nowrap flex flex-row gap-2 w-full text-white  bg-gray-400 hover:bg-emerald-500 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" title="Load Saved Search">'
                ...
                savedItemsList +=  '<button type="button" data-saved-search-title="'+saveTitle+'" class="saved-search-overwrite whitespace-nowrap w-8 bg-amber-500 hover:bg-amber-900 mb-2 rounded-lg" title="Overwrite">';
                ...
                savedItemsList +=  '<a href="#" data-saved-search-title="'+saveTitle+'" class="saved-search-remove whitespace-nowrap w-8 bg-red-500 hover:bg-red-900 mb-2 rounded-lg" title="Remove Saved Search">'
