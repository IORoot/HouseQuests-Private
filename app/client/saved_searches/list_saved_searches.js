    ...
    if (savedSearches){
        ...
        for (const key in savedSearches) {
            ...
            savedItemsList += '<div class="flex flex-row gap-2 h-12">'
                ...
                savedItemsList += '<button data-saved-search-title="'+saveTitle+'" type="button" class="load-saved-search whitespace-nowrap flex flex-row gap-2 w-full   text-white  bg-emerald-900 hover:bg-orange-300    font-medium rounded-lg text-sm px-5 py-2.5 mb-2" title="Load Saved Search">'
                    ...
                    savedItemsList += '<span class="pointer-events-none w-full my-auto text-left">Load : '+saveTitle+'</span>'
                ...
                savedItemsList +=  '<button type="button" data-saved-search-title="'+saveTitle+'" class="saved-search-overwrite whitespace-nowrap text-xs px-2   text-white bg-emerald-700 hover:bg-orange-300    mb-2 rounded-lg flex flex-row gap-1" title="Overwrite">';
                    ...
                    savedItemsList +=  '</svg>'
                    savedItemsList +=  '<span class="my-auto pr-1">Overwrite</span>';
                savedItemsList +=  '</button>';
                ...
                savedItemsList +=  '<a href="#" data-saved-search-title="'+saveTitle+'" class="saved-search-remove whitespace-nowrap text-xs px-2     text-white bg-orange-900 hover:bg-orange-700    mb-2 rounded-lg mb-2 rounded-lg flex flex-row gap-1" title="Remove Saved Search">'
                    savedItemsList +=  '<svg class="pointer-events-none -auto w-4 h-10 m-auto fill-gray-100 hover:fill-orange-900" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">'
                    ...
                    savedItemsList +=  '</svg>'
                    savedItemsList +=  '<span class="my-auto pr-1">Delete</span>';
                savedItemsList +=  '</a>'
