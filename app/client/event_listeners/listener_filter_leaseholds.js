...
export function listener_filter_leaseholds()
{
    ...
    var filter_leaseholds_button = document.getElementById("filter-all-leasehold");
    filter_leaseholds_button.addEventListener('click', filterLeaseholds, false);
